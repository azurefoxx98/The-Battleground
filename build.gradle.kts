...
tasks.register("runServerWithSync") {
    group = "hytale"  // Keeps it in the same Gradle group as your other Hytale tasks
    description = "Runs the Hytale server, then automatically syncs any in-game asset changes back to your source code after you stop the server."

    // This makes sure the server runs first
    dependsOn("runServer")

    // This runs syncAssets AFTER the runServer task finishes
